...
export default async function GamePage({ params }) {
  ...
  const jsonLdData = {
    ...
    "datePublished": game.createdAt ? new Date(game.createdAt).toISOString() : undefined,
    "aggregateRating": game.popularity !== undefined ? {
      "@type": "AggregateRating",
      "ratingValue": game.popularity,
      "reviewCount": 1
    } : undefined,
    "applicationCategory": "Game",
    "operatingSystem": "Windows, macOS",
    "sameAs": game.steamUrl ? [game.steamUrl] : [],
  };

  return (
    <>
      {/* JSON-LD structured data for SEO (SSR, in body) */}
      <script
